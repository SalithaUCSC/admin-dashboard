                        ...
                        <div className="card card-primary">
                            ...
                            <div className="card-body">
                                <form className="needs-validation" noValidate="">
                                    ...
                                    <div className="form-group">
                                        <button type="submit" onClick={login} className="btn btn-primary btn-lg btn-block" tabIndex="4">
                                            Login
                                        </button>
                                        <button onClick={clear} className="btn btn-outline-danger btn-lg btn-block">
                                            CLEAR
                                        </button>
                                    </div>
                                </form>
